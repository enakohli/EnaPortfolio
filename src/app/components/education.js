...
const Education = () => {
    ...
    return (
        <div className="bg-gray-900 text-white py-20 w-screen font-geist" id="education">
            <div
                ref={sectionRef}
                className="max-w-4xl mx-auto bg-gray-700 shadow-md rounded-lg p-8"
            >
                <h1 className="text-4xl font-geist mb-8 text-center text-white">
                    Education
                </h1>
                <div className="space-y-6">
                    <div className="p-6 border-b border-gray-600 grid grid-cols-3 gap-4 items-center rounded-md">
                        <Image
                        ...
                        <div className="col-span-2">
                            ...
                            <p className="text-gray-400 mt-2">
                                <span className="font-medium text-indigo-400">Key Highlights:</span> 80%+ Average, President's Scholarship of Distinction
                            </p>
                        </div>
                    </div>
                </div>
